...
public class CustomDataSourceConfig {
    ...
    public DataSource routingDataSource() {
        ...
        dataSourceMap.put(databaseProperty.getSlave().getName(), createDataSource(databaseProperty.getSlave().getUrl()));

        ReplicationRoutingDataSource replicationRoutingDataSource = new ReplicationRoutingDataSource(databaseProperty);
